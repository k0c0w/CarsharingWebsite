...
export function GreetingSection({backgroundImageSource, title, subtitle, children}){
    const section = useRef(null);
    useEffect(() => { section?.current.classList.add("loaded")}, []);

    return <Section ref={section}>
    <div className="flex-container greeting-screen greeting-background" style={{backgroundImage:`url(${backgroundImageSource})`}}>
        <div>
