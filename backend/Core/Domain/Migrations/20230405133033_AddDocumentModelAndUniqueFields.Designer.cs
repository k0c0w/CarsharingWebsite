...
namespace Domain.Migrations
{
    ...
    [Migration("20230405133033_AddDocumentModelAndUniqueFields")]
    partial class AddDocumentModelAndUniqueFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.CarModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Model.Tariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Model.UserInfo", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Model.Car", b =>
                {
                    b.HasOne("Domain.Model.CarModel", "CarModel")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.CarModel", b =>
                {
                    b.HasOne("Domain.Model.Tariff", "Tariff")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.User", b =>
                {
                    b.HasOne("Domain.Model.UserRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.UserInfo", b =>
                {
                    b.HasOne("Domain.Model.User", "User")
                        .WithOne("UserInfo")
                        .HasForeignKey("Domain.Model.UserInfo", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
