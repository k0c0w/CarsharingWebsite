        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Tariff_Price", "\"Price\" > 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebsiteDocuments", x => x.FileName);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverLicense = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarModels_Tariffs_TariffId",
                        column: x => x.TariffId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasToBeNonActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsOpened = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsTaken = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ParkingLatitude = table.Column<double>(type: "double precision", nullable: false),
                    ParkingLongitude = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Subscriptions_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id");
                });
