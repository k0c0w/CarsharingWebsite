    ...
    public class S3ServiceClient : ClientBase
    {
        ...
        public async Task<WebCallResult<IEnumerable<AttachmentInfo>>> GetAttachmentInfosByIdsAsync(Guid attachmentGuid)
        {
            ...
            try
            {
                ...
                {
                    return new WebCallResult<IEnumerable<AttachmentInfo>>(new ServerError<IEnumerable<AttachmentInfo>>(await response.Content.ReadAsStringAsync()));
                }
            ...
            {
                return new WebCallResult<IEnumerable<AttachmentInfo>>(new ServerError<IEnumerable<AttachmentInfo>>(ex.Message));
            }
        }
